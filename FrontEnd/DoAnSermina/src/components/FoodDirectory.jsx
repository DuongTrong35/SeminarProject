...
const foodShops = [
  { id: 1, name: "Ốc Hương Nướng", image: "https://images.unsplash.com/photo-1628080135872-b6e9e2e691a9?auto=format&fit=crop&w=400&q=80", description: "Fresh grilled snails with herbs.", address: "123 Vinh Khanh St", rating: 4.5, reviews: 128, category: "Snails" },
  { id: 2, name: "Ghẹ Rang Me", image: "https://images.unsplash.com/photo-1598866533593-1c0e4f9a7d3d?auto=format&fit=crop&w=400&q=80", description: "Spicy stir-fried crab.", address: "124 Vinh Khanh St", rating: 4.8, reviews: 95, category: "Seafood" },
  ...
  { id: 4, name: "Sò Điệp Nướng Mỡ Hành", image: "https://images.unsplash.com/photo-1606756796315-d9a8a0eb1c94?auto=format&fit=crop&w=400&q=80", description: "Scallops grilled with scallion oil.", address: "126 Vinh Khanh St", rating: 4.7, reviews: 112, category: "BBQ" },
  { id: 5, name: "Hải Sản Nướng", image: "https://images.unsplash.com/photo-1576402187877-3db68b1c8c40?auto=format&fit=crop&w=400&q=80", description: "Assorted grilled seafood.", address: "127 Vinh Khanh St", rating: 4.3, reviews: 89, category: "BBQ" },
  { id: 6, name: "Bạch Tuộc Nướng", image: "https://images.unsplash.com/photo-1623862440600-2c1430ccfb66?auto=format&fit=crop&w=400&q=80", description: "Grilled octopus tentacles.", address: "128 Vinh Khanh St", rating: 4.6, reviews: 134, category: "BBQ" },
  { id: 7, name: "Cua Rang Me", image: "https://images.unsplash.com/photo-1551782450-17144efb5723?auto=format&fit=crop&w=400&q=80", description: "Spicy stir-fried crab.", address: "129 Vinh Khanh St", rating: 4.4, reviews: 67, category: "Seafood" },
  ...
  { id: 9, name: "Bánh Xèo", image: "https://images.unsplash.com/photo-1551782450-17144efb5723?auto=format&fit=crop&w=400&q=80", description: "Vietnamese crispy pancake.", address: "131 Vinh Khanh St", rating: 4.5, reviews: 98, category: "Street Food" },
  ...
  { id: 11, name: "Gỏi Cuốn", image: "https://images.unsplash.com/photo-1551782450-17144efb5723?auto=format&fit=crop&w=400&q=80", description: "Fresh spring rolls.", address: "133 Vinh Khanh St", rating: 4.3, reviews: 82, category: "Street Food" },
